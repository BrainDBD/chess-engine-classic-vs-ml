...
```
Comenziile de mai jos folosesc două seturi de date create din fișiere PGN oferite de [Lichess Open Database](https://database.lichess.org/#standard_games): `endgame.jsonl` a fost creat din fișierul PGN luat din luna Aprilie 2026, iar `may_static-test.jsonl` este setul de date obținut din fișierul lunii Mai, filtrat cu ajutorul script-ului `ml/sample_static_test.py`.
